sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/zaz/com/Materiallist/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.zaz.com.Materiallist.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/zaz/com/Materiallist/localService/mockserver"], function (mockserver) {
